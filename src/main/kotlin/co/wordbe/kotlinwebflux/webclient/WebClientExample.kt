package co.wordbe.kotlinwebflux.webclient

import co.wordbe.kotlinwebflux.domain.book.Book
...
class WebClientExample {
    ...
    fun getBooksBlockingWay() : List<Book> {
        ...
        val response = restTemplate.exchange(url, HttpMethod.GET, null, object :
